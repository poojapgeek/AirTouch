...
def respond(voice_data):
    ...
    elif 'what does' in voice_data and 'mean' in voice_data:
        word = voice_data.split("what does")[1].split("mean")[0].strip()
        message = get_word_definition(word)
        reply(message)
    ...
    print(f"Response Time: {response_time:.2f} seconds")  # Log the response time
